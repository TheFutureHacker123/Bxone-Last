    ...
    <div className="dashboard-wrapper">
      ...
      <div className={`admin-custom-sidebar ${sidebarVisible ? "show" : "hide"}`}>
        ...
        <div className="dropdown">
          ...
          {openDropdown === "products" && (
            <ul className="dropdown-menu admin-custom-dropdown-menu">
              <li><a href="/admin/list-users" className="dropdown-item-admin">{content?.list_users || "List Users"}</a></li>
              <li><a href="/admin/user-messages" className="dropdown-item-admin">{content?.user_messages || "User Messages"}</a></li>
            </ul>
          )}
        </div>
        ...
        <div className="dropdown">
          ...
          {openDropdown === "orders" && (
            <ul className="dropdown-menu admin-custom-dropdown-menu">
              <li><a href="/admin/new-vendors" className="dropdown-item-admin">{content?.new_vendors || "New Vendors"}</a></li>
              <li><a href="/admin/list-vendors" className="dropdown-item-admin">{content?.list_of_vendors || "List of Vendors"}</a></li>
              <li><a href="/admin/manage-products" className="dropdown-item-admin">{content?.manage_products || "Manage Products"}</a></li>
              <li><a href="/admin/manage-orders" className="dropdown-item-admin">{content?.manage_orders || "Manage Orders"}</a></li>
              <li><a href="/admin/approve-payout" className="dropdown-item-admin">{content?.approve_payout || "Approve Payout"}</a></li>
              <li><a href="/admin/vendor-messages" className="dropdown-item-admin">{content?.vendor_messages || "Vendor Messages"}</a></li>
            </ul>
          )}
        </div>
        ...
        <div className="dropdown">
          ...
          {openDropdown === "profile" && (
            <ul className="dropdown-menu admin-custom-dropdown-menu">
              <li><a href="/admin/manage-password" className="dropdown-item-admin">{content?.update_password || "Update Password"}</a></li>
