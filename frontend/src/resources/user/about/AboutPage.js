...
function AboutPage() {
  ...
  const aboutContent = [
    ...
    { text: "Founded in [Year of founding], Habesha Mart started as a small initiative driven by a ", emphasis: "passion", rest: " for Ethiopian craftsmanship and entrepreneurship. We saw the incredible potential of bringing traditional artistry and modern innovation together in one accessible space." },
